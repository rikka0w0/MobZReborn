...
public class SpeedShoeBase extends ArmorItem {
    ...
    public SpeedShoeBase(IArmorMaterial material, EquipmentSlotType slot, Item.Properties properties, double speedBoost) {
	...
	public void appendHoverText(ItemStack itemStack, @Nullable World world, List<ITextComponent> tooltip, ITooltipFlag flag) {
		tooltip.add(new TranslationTextComponent("item.mobz.speed_boots.tooltip"));
	}
