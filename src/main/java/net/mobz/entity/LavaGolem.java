...
public class LavaGolem extends IronGolem {
	...
	public static AttributeSupplier.Builder createMobzAttributes() {
		return Monster.createMonsterAttributes()
				.add(Attributes.MAX_HEALTH, MobZ.configs.lava_golem.life * MobZ.configs.life_multiplier)
				.add(Attributes.MOVEMENT_SPEED, 0.25D)
				.add(Attributes.ATTACK_DAMAGE, MobZ.configs.lava_golem.attack * MobZ.configs.damage_multiplier)
	...
	public boolean checkSpawnObstruction(LevelReader view) {
		...
		return MobZ.configs.lava_golem.spawn
