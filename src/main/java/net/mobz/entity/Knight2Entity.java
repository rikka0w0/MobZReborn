...
public class Knight2Entity extends Vindicator {
	...
	public static AttributeSupplier.Builder createKnight2EntityAttributes() {
		return Monster.createMonsterAttributes()
				.add(Attributes.MAX_HEALTH, MobZ.configs.WarriorLife * MobZ.configs.LifeMultiplicatorMob)
				.add(Attributes.MOVEMENT_SPEED, 0.32D)
				.add(Attributes.ATTACK_DAMAGE, MobZ.configs.WarriorAttack * MobZ.configs.DamageMultiplicatorMob)
	...
	public boolean checkSpawnObstruction(LevelReader view) {
		...
		return view.isUnobstructed(this) && this.level.getMaxLocalRawBrightness(posentity) < 10
				&& !this.isPatrolLeader() && !level.containsAnyLiquid(this.getBoundingBox())
