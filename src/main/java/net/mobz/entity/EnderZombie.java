...
public class EnderZombie extends Zombie {
	...
	public static AttributeSupplier.Builder createMobzAttributes() {
		return Monster.createMonsterAttributes()
				.add(Attributes.MAX_HEALTH, MobZ.configs.ender_zombie.life * MobZ.configs.life_multiplier)
				.add(Attributes.MOVEMENT_SPEED, 0.23D)
				.add(Attributes.ATTACK_DAMAGE, MobZ.configs.ender_zombie.attack * MobZ.configs.damage_multiplier)
