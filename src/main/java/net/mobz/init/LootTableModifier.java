...
public class LootTableModifier {
    ...
    public static void loadAll(ILootTableAdder lootTableAdder) {
    	lootTableAdder.addRoll(LONE, BinomialDistributionGenerator.binomial(1, 0.3f), LootItem.lootTableItem(MobZItems.WHITE_BAG.get()));
    	...
    	lootTableAdder.addRoll(LTHREE, BinomialDistributionGenerator.binomial(2, 0.2f), LootItem.lootTableItem(MobZItems.WITHER_POWDER.get()));
    	lootTableAdder.addRoll("minecraft:entities/wither_skeleton", BinomialDistributionGenerator.binomial(1, 0.1f), LootItem.lootTableItem(MobZItems.WITHER_POWDER.get()));
    }
}
