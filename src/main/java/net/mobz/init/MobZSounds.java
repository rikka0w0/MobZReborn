...
public class MobZSounds {
    ...
    public static final Supplier<SoundEvent> MEDIVEALSOUNDEVENT = register("medivealsound");
    public static final Supplier<SoundEvent> MEDIVEALSOUND2EVENT = register("medivealsound2");
