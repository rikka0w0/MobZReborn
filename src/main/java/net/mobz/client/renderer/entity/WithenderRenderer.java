...
public class WithenderRenderer extends MobRenderer<Withender, WitherBossModel<Withender>> {
   private static final ResourceLocation SKIN = new ResourceLocation("mobz:textures/entity/wither.png");

   public WithenderRenderer(EntityRendererProvider.Context context) {
