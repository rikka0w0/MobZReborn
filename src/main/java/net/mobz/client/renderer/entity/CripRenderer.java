...
public class CripRenderer extends MobRenderer<CreeperEntity, CreeperModel<CreeperEntity>> {
   private static final ResourceLocation SKIN = new ResourceLocation("mobz:textures/entity/crip.png");

   public CripRenderer(EntityRendererManager entityRenderDispatcher) {
