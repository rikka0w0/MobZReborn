...
public class WaspModel<T extends Wasp> extends AgeableListModel<T> {
   ...
   public WaspModel(ModelPart p_170439_) {
   ...
   public static LayerDefinition createBodyLayer() {
      ...
      PartDefinition partdefinition1 = partdefinition.addOrReplaceChild("bone", CubeListBuilder.create(), PartPose.offset(0.0F, BEE_Y_BASE, 0.0F));
